...
/**
 * Servlet que lista los usuarios para poder enviar un mensaje
 * @author Artur Viader
 */
public class EnviarMensajeListUsers extends HttpServlet {
@EJB
     MsgBean miDao;
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        //Se obtienen todos los usuarios menos el que ha inciado sesión
        List<User> users = miDao.getUsuarios(usuario.getUsername());
        //Se mandan los usuarios al jsp
